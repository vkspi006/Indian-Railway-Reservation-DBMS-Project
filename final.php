...
<div id="Container">
  <div id="header_"> 
    <ul class="navi">
      ...
      <li><a href="p2.php">Book Now</a></li>
	  <li><a href="signout.php">Sign Out</a></li>
    </ul>
  </div>
  <div id="left_">
  <br>
    <h2>&nbsp PRINT TICKET</h2>
...
<p><span><b></b>
  ...
  <div id="right_">
    <h2>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  Fill Details</h2>
    <p><span class="style1"></span>  </p>
	<br><p>Credit Card Details:
<input type="text" name="ccd" size="30" value="" />
</p>
<br>
